...
app.get('/sim/devicedata/:deviceId', function(req, res){
	...
	console.log(num_requests + ': requesting device data for device: ' + req.params.deviceId);
			  ...
			  "laria":
			  	{
				    ...
				    "sensors": [
						...
						},
						{
							"id": 5,
							"name": "glucose_level",
							"value": generateRandomValue(2,23),
							"type_sensor": 6
						}
				    ]
				}
...
app.get('/sim/ekg/:deviceId', function(req, res){
	...
	console.log(num_requests + ': requesting ekg data for device: ' + req.params.deviceId);
	num_requests++;
