                                                    ...
                                                    <tr>
                                                        <td valign="top" class="textContent">
                                                            <div style="text-align:justify; font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                                Estimado {{ $doctor->user->name.' '.$doctor->user->lastname }}:<br>
                                                                Por este medio le confirmamos que ha sido solicitada una cita para usted por el paciente {{ $patient->user->name.' '.$patient->user->lastname }} solicitud corresponde a la siguiente fecha y hora: <b>{{ $appointment->date }}</b>
                                                                <br>
                                                                Inicie sesión en el sistema para proceder a aprobar o denegar la solicitud.
                                                                <br>
                                                                <br>
                                                                <br>
