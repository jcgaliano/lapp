                                                    ...
                                                    <tr>
                                                        <td valign="top" class="textContent">
                                                            <div style="text-align:justify; font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                                ...
                                                                Por este medio le confirmamos que ha sido programada una cita para usted con el doctor {{ $doctor->user->name.' '.$doctor->user->lastname }}, la cita será efectuada a la siguiente fecha y hora: <b>{{ $appointment->date }}</b>
                                                                <br>
                                                                <br>
                                                                <br>
