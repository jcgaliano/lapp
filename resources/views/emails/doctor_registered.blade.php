                                                    ...
                                                    <tr>
                                                        <td valign="top" class="textContent">
                                                            <div style="text-align:justify; font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                                ...
                                                                Le damos la bienvenida a nuestro sistema. Su cuenta ha sido creada satisfactoriamente.
                                                                <br>
                                                                Para poder hacer inicio de sesión en el sistema usted debe activar la cuenta y un supervisor debe aprobar su solicitud. Comencemos por activar la cuenta haciendo click en el botón que sigue a continuación.
                                                                <br>
                                                                <br>
                                                                <br>
